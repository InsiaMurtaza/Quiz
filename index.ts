...
let quizQuestions= await inquirer.prompt([{
    ...
    type:"list"},  // correct_answer1:"B) A superset of JavaScript that adds static types"
    {
    name:"answer1",   
